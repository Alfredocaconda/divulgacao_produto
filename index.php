...
<head>
 ...
 <link rel="stylesheet" href="restrito/estilo.css">
  <!------- LINK DO JAVASCRIPT-->
  <link rel="stylesheet" href="restrito/js/script.js">
  <!--LINK DE ICONES-->
...
<body>
    ...
    <section id="cabecalho">
      <a href="#" class="logo_tipo"><img width="210" src="restrito/logotipo/logo.jpg" alt="#" /></a>
      <!--INICIO DO NAVEGADOR-->
      <div>
        <ul id="navbar">
          <li><a class="active" href="index.php">PAGINA PRINCIPAL</a></li>
          <li><a href="restrito/login.php">LOJA</a></li>
          <li><a href="acerca.php">ACERCA</a></li>
          <li><a href="restrito/login.php">LOGIN</a></li>
          <li id="lg-bag"><a href="loja.php"><i class="far fa-shopping-bag"></i></a></li>
    ...
    <section id="feature" class="section-p1">
      <?php
        ...
        include 'restrito/Connection/conexao.php';
        //pegar os dados apartir do banco de dados
        $sql="SELECT * FROM vstock limit 5";
    ...
    <section id="product1" class="section-p1">
      ...
      <?php
        ...
        include 'restrito/Connection/conexao.php';
        //pegar os dados apartir do banco de dados
        $sql2="SELECT * FROM vstock ORDER BY nome ASC
        LIMIT 8 OFFSET 2";
        //executar a query que ira ser declarado uma variavel que ira receber a conexao e os dados do banco de dados
        //esta variavel ira receber todos os objectos do banco de dados
  ...
  <footer class="section-p1">
    ...
    <img width="210" src="restrito/logotipo/logo.jpg" alt="#" />
    </a>
        <h4>CONTACTO</h4>
    ...
    <div class="col install">
      ...
      <div class="row">
        <a href="#"><img src="restrito/imagens/PLAY STORY.jpg" alt="" class="imagens"></a>
      </div>
      <p>GATEWAYS DE PAGAMENTO SEGURO</p>
      <a href="#"><img src="restrito/imagens/VISA.png" alt="" class="imagens"></a>
    </div>
    <div class="copyrigth">
