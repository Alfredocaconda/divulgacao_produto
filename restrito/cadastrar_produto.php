...
<a href="admin.php"><img class="logo_icon img-responsive"
src="logotipo/logo.jpg" alt="#" />
</a>
</div>
</div>
...
<div class="row">
<div class="col">
<form action="Controller/Cadastrar_Produto.php" method="Post" enctype="multipart/form-data" class="row g-3">
...
placeholder="DIGITE AQUI A SUA CATEGORIA" required>
</div>
<div class="col-md-6">
