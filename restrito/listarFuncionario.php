...
$sql="SELECT * FROM usuario WHERE funcao <> '' and nome LIKE '%$pesquisar%' ";
...
<div class="container-fluid">
<form class="d-flex" action="listarFuncionario.php" method="POST" role="search">
...
echo " <tr>
<th width=10px scope='row'>$nome</th>
<th width=10px >$genero</th>
<th width=10px >$telefone</th>
<th width=10px >$senha</th>
<th width=10px >$funcao</th>
<th width=10px >$endereco</th>
<th >$data_nascimento</th>
<th >
<a href='editarFuncionario.php?idf=$idfuncionario' 
