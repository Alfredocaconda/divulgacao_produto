...
include 'Connection/conexao.php';
    ...
    $sql="SELECT * FROM `vproduto` WHERE `idproduto`='$idproduto'";
        ...
        <div class="inner_container">
            ...
            <div id="content">
                ...
                <section class="content">
                    <h2>Actualizar os Produtos</h2>  
                    <!--LINHA-->
                    <div class="row">
                        <div class="col">
                            <form action="Controller/Produto_actualizar_script.php" method="Post" enctype="multipart/form-data" class="row g-3">
                                <input type="hidden" name="idusuario" value="<?php echo $_SESSION['idusuario'] ?>">
                                <input type="hidden" name="idproduto" value="<?php echo $linha['idproduto'] ?>">
                                <div class="col-md-6">
                                    <label for="inputEmail4" class="form-label">Nome Produto</label>
                                ...
                                <div class="col-md-6">
                                    <label for="endereco" class="form-label">Categoria</label>
                                    <input type="text" class="form-control" id="inputAddress" name="categoria"
                                    placeholder="DIGITE AQUI A SUA CATEGORIA" value="<?php echo $linha['categoria'] ?>" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="telefone" class="form-label">Descrição</label>
                                    <input type="text" class="form-control" id="inputAddress" name="descricao" 
                                    placeholder="DIGITE AQUI A SUA DESCRIÇÃO" value="<?php echo $linha['descricao'] ?>" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="foto" class="form-label">Inserir Imagem</label>
                                    <input type="file" class="form-control" value="<?php echo $linha['imagem'] ?>" name="imagem" 
