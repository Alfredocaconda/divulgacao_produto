...
<body class="dashboard dashboard_1">
    <div class="full_container">
        <div class="inner_container">
            ...
            <nav id="sidebar">
                ...
                <div class="sidebar_blog_2">
                    ...
                    <ul class="collapse list-unstyled" id="dashboard">
                        ...
                        <li><a href="listarFuncionario.php">> <span>LISTAR</span></a></li>
                    </ul>
                    <li>
                    ...
                    <li><a href="#apps" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-object-group blue2_color"></i> <span>USUARIO</span></a>
            ...
            <div id="content">
                ...
                <section class="content">
                    <h2>Actualizar dados do Funcionario</h2>  
                        <!--LINHA-->
                        <div class="row">
                            <div class="col">
                                <form action="Controller/ActualizarFuncionario.php" method="Post" enctype="multipart/form-data" class="row g-3">
                                    <input type="hidden" name="idf" value="<?php echo $linha['idusuario'] ?>">
                                        <div class="col-md-6">
                                            <label for="inputEmail4" class="form-label">Nome Completo</label>
                                            <input type="text" class="form-control" name="nome" id="inputEmail4" 
                                            placeholder="DIGITE AQUI O SEU NOME" value="<?php echo $linha['nome'] ?>">
                                        </div>
                                        <div class="col-md-4">
                                            </br>
                                            <select id="inputState" name="genero" value="<?php echo $linha['genero'] ?>" class="form-select" >
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            value="<?php echo $linha['data_nascimento'] ?>" id="inputZip" >
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            value="<?php echo $linha['bi'] ?>" placeholder="DIGITE AQUI A SUA MORADA" >
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select id="inputState" name="funcao" value="<?php echo $linha['funcao'] ?>" class="form-select" >
        ...
        <div class="container-fluid">
            <div class="footer"><p>@ 2024, HOUSE SMARTH CONVENCIONAL LDA </p></div>
        </div>
    <!-- jQuery -->
