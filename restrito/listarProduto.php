...
$sql="SELECT * FROM vproduto WHERE nome LIKE '%$pesquisar%'  ORDER BY nome desc";
...
<div class="container-fluid">
<form class="d-flex" action="listarProduto.php" method="POST" role="search">
...
echo " <tr>
<th width=100px>$mostrar_foto</th>
<th width=100px scope='row'>$nome</th>
<th width=100px >$categoria</th>
<th width=100px >$descricao</th>
<th width=100px >$idusuario</th>
<th>
<a href='editarproduto.php?idproduto=$idproduto'
class='btn btn-success btn-sm'>Editar</a>
<a href='cadastrarStock.php?idproduto=$idproduto' class='btn btn-primary btn-sm' >Stock</a>
<a href='#' class='btn btn-danger btn-sm'  data-toggle='modal'
data-target='#confirma'
onclick=" .'"' ."pegar_dados($idproduto,'$nome')" .'"' ."
>Apagar</a>
</th>
...
<form action="Controller/apagarProduto.php" method="post">
