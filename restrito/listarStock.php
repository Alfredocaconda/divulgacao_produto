...
$sql="SELECT * FROM vstock WHERE nome LIKE '%$pesquisar%' ";
...
<div class="container-fluid">
<form class="d-flex" action="listarStock.php" method="POST" role="search">
...
<th scope="col">Tempo de duracao</th>
...
<th width:100px >$nome/$descricao/$categoria</th>
<th width:10px >$quantidade</th>
<th width:10px >$tempo</th>
<th >$data</th>
<th width:10px >$preco kz</th>
<th >$funcionario</th>
</tr>";
}
